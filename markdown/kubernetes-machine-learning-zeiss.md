...
## Motivation for applying at Zeiss SMT
- I like complex machines
  - Rolling boxes are not my favourite thing though (limits selection in Germany)
- Did i mention i like computers? Semiconductors go into those, so i get to contribute to making more of what i like
- I've always enjoyed astronomy, why not work for a company that makes optics
- All in all a good opportunity to work at an enterprise that moves Germany forward rather than backward
  - Being able to identify with the products is a plus
